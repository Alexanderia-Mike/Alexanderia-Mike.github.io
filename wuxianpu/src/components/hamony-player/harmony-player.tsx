...
export function HarmonyPlayer() {
  ...
  if (higherSamplerRef.current === null)
    higherSamplerRef.current = getSampler(false, true);
  if (lowerSamplerRef.current === null)
    lowerSamplerRef.current = getSampler(false, true);
