...
//     return [
//         new NoteName(new WhiteKeyNoteName(NoteNameBase.A, 2)),
//         new NoteName(new WhiteKeyNoteName(NoteNameBase.C, 3)),
//     ]
// }
...
//     const higherSampler = getSampler(false)
//     const lowerSampler = getSampler(false)
...
//         higherSampler.triggerAttack(noteToSampleId(newNotes[0]))
//         lowerSampler.triggerAttack(noteToSampleId(newNotes[1]))
//     }

//     const stopHarmony = () => {
//         if (!isToneEnabled() || !notes) return

//         higherSampler.triggerRelease(noteToSampleId(notes[0]))
//         lowerSampler.triggerRelease(noteToSampleId(notes[1]))
//         setIsPlaying(false)
//     }
...
//         higherNoteGainRef.current.gain.value = (100 - volumeRatio) / 100
//     }, [volumeRatio])
