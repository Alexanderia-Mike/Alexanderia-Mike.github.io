...
const KEY_SIGNATURE_TABLE: Record<KeySignature, KeySignatureEntry> = {
  [KeySignature.C]: {
    tonic: (octave) =>
      new NoteName(new WhiteKeyNoteName(NoteNameBase.C, octave)),
    sharpNotes: [],
    flatNotes: [],
  },
  [KeySignature.G]: {
    tonic: (octave) =>
      new NoteName(new WhiteKeyNoteName(NoteNameBase.G, octave)),
    sharpNotes: [NoteNameBase.F],
    flatNotes: [],
  },
  [KeySignature.D]: {
    tonic: (octave) =>
      new NoteName(new WhiteKeyNoteName(NoteNameBase.D, octave)),
    sharpNotes: [NoteNameBase.F, NoteNameBase.C],
    flatNotes: [],
  },
  [KeySignature.A]: {
    tonic: (octave) =>
      new NoteName(new WhiteKeyNoteName(NoteNameBase.A, octave)),
    sharpNotes: [NoteNameBase.F, NoteNameBase.C, NoteNameBase.G],
    flatNotes: [],
  },
  [KeySignature.E]: {
    tonic: (octave) =>
      new NoteName(new WhiteKeyNoteName(NoteNameBase.E, octave)),
    sharpNotes: [
      NoteNameBase.F,
      NoteNameBase.C,
      NoteNameBase.G,
  ...
  [KeySignature.B]: {
    tonic: (octave) =>
      new NoteName(new WhiteKeyNoteName(NoteNameBase.B, octave)),
    sharpNotes: [
      NoteNameBase.F,
      NoteNameBase.C,
      NoteNameBase.G,
  ...
  [KeySignature.F]: {
    tonic: (octave) =>
      new NoteName(new WhiteKeyNoteName(NoteNameBase.F, octave)),
    sharpNotes: [],
...
export function getFlatNotesForKey(
  keySignature: KeySignature,
): readonly NoteNameBase[] {
